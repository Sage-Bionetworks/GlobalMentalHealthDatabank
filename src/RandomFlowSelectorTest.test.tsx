...
test('Generate Random Flow Selection', () => {
  let rand1 = function () {
    ...
    console.log(
      'total count actual: ' + +randomCount.reduce((a, b) => a + b, 0),
    )
    console.log(
      'expected 16.667%. Actual pct: ' + (randomCount[0] / totalCount) * 100,
    )
    console.log(
      'expected 16.667%. Actual pct: ' + (randomCount[1] / totalCount) * 100,
    )
    console.log(
      'expected 16.667%. Actual pct: ' + (randomCount[2] / totalCount) * 100,
    )
    console.log(
      'expected 50%. Actual pct: ' + (randomCount[3] / totalCount) * 100,
    )
  }
  rand1()
})
